...
const DescriptionRegistrasiInstansiComponent = ({ data }) => {
    return (
        <Descriptions column={1} layout="horizontal" size="small" bordered>
            <Descriptions.Item label="Nama Asosiasi" span={1}> {data.nama_instansi} </Descriptions.Item>
            ...
            <Descriptions.Item label="Alamat Asosiasi" span={1}> {data.alamat_instansi} </Descriptions.Item>
