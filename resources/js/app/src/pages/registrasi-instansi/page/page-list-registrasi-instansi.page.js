...
const routes = [
    {
        ...
        breadcrumbName: 'List Registrasi Instansi',
    },
];

const PageListRegistrasiInstansi = () => {
    ...
    return (
        <React.Fragment>
            <PageHeader
                ...
                title="List Registrasi Instansi/Satker/Unit Kerja"
                breadcrumb={{ routes }}
            />
            <Content style={{ margin: '24px 25px 0', overflow: 'initial' }}>
                <div style={{ padding: '24px', background: '#fff' }}>
                    ...
                    <div style={{ padding: "0 0 24px 0" }}>
                        <Button 
                            type="primary" 
                            href={`${document.querySelector('meta[name="base-url"]').getAttribute('content')}/export/registrasi/instansi`} > 
                                Export Excel 
                        </Button>  
                    </div>
...
export default React.memo(PageListRegistrasiInstansi)
