...
export default class RegistrasiInstansiStore {
    ...
    async fetchData() {
        ...
        const result = await this.api.get('/registrasi/instansi')
    ...
    async register(data) {
        ...
        // SEND DATA TO SERVER
        const result = await this.api.post('/registrasi/instansi', data
...
decorate(RegistrasiInstansiStore, {
    data: observable,
