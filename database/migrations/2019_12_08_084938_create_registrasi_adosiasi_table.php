...
class CreateRegistrasiAdosiasiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('registrasi_adosiasi', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('registrasi_adosiasi');
    }
}
